                  ...
                  Row(
                    children: [
                      ...
                      Icon(
                        Icons.star,
                        color: Colors
                            .yellow, // Puedes ajustar el color según tu preferencia
                      )
                    ],
                  ),
                  const SizedBox(height: 20),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 10),
                          const Text(
                            "Fundada en 1982 en Perú,\nes una asociación sin fines de lucro\nrespaldada por empresarios locales.\nHa expandido su infraestructura con\ndonaciones de empresas nacionales y\napoyo internacional, destacando la\ncontribución clave de Baden\nWürttemberg en Alemania, así\ncomo el respaldo de instituciones\ncomo el Banco Interamericano de\nDesarrollo y la Agencia Internacional\npara el Desarrollo de EE. UU.",
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                            ),
